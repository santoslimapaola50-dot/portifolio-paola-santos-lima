...
| :--- | :--- | :---: |
| **teste** | Desenvolvimento de algoritmos modulares em pseudocódigo para gestão financeira, climática e escolar, aplicando a decomposição e o isolamento de escopo para garantir a segurança e a coesão do sistema.| [Ver Projeto](./ex20/). |
